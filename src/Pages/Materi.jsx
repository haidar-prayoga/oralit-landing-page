...
const Materi = () => {
    return (
        <>
            <Navbar className={"sticky top-0"}><span className="text-green-500">Di</span>are</Navbar>
            {/* First Row */}
            <div className="mx-auto px-4 py-2">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <img src="/images/doctor.jpg" alt="doctor" className="w-full h-full object-cover rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:shadow-gray-600" />
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto px-4 py-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="col-span-1">
                        <img src="/images/obat.png" alt="obat" className="w-full h-full object-cover rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover:shadow-gray-600" />
                    </div>
